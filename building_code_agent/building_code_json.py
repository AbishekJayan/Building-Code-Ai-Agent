BUILDING_CODE_JSON = {
    ...
    "plumbing_code": {},
    "mechanical_code": {},
    "general": {"description": "Footings shall be constructed of concrete."},
    "storm_shelters": {
    ...
    "occupied_roofs": {
        ...
        "exception": "No guard rail for  Private roof top decks less than 735 square feet that are accessed from within an individual dwelling or sleeping unit and are intended and designed for the sole use of the owner or tenant.",
    },
    "roof_draininage": {
        "description": """
When roofs are sloped to drain over the edge, scuppers or gutters and downspouts, adequately sized, pitched and supported, shall be
installed to conduct rain water to ground level. Rain water shall be discharged at least three
feet away from the building foundation in a direction parallel to the adjoining property line
when the discharge point is within 20 feet of the adjoining property line.
    """
    },
    "soil_lateral_load": {
        ...
        "Clayey gravels, poorly graded gravel- andclay mixes": {
    ...
    "frost_protection": {
        "description": """
        Except where erected on solid rock or otherwise protected from frost, foundation walls,
piers, and other permanent supports of buildings and structures larger than 750 square feet
in area or 10 feet in height shall extend below the established frost line. The established
frost line shall be 3. 5 feet below the exterior grade for he-ated sfr ores— a, d 5- feae«
unheated structures

1. The bottom surface of footings for unattached garages and unattached storage buildings
of wood or metal not more than 750 square feet in area shall not be less than 1 foot
below grade.

2. The bottom surface of foundations that bear on rock surfaces is not required to be below
the established frost line provided the rock does not have seams or cracks or contain
disintegrated material that could serve as reservoirs for water which could be subject to
freezing.

3. The support of buildings by posts embedded in the earth shall be designed as specified
in Section 1808. Wood posts or poles embedded in soil or concrete shall be pressure
treated with an approved preservative
"""
    },
    "masonry_unit_footings": {"description": "Not allowed."},
    "timber_footings": {"description": "Not allowed"},
}
